# Nginx with HTTP/3, KTLS, zstd, and ModSecurity for AlmaLinux 10

This repository provides an unofficial Nginx RPM build for AlmaLinux 10.
...
```text
https://github.com/redadmin-k/modsecurity-almalinux10
```

Install the ModSecurity RPM first:

```bash
git clone https://github.com/redadmin-k/modsecurity-almalinux10.git
cd modsecurity-almalinux10
...
server {
    listen 80;
    server_name alma10.redadmin.org;
...
```bash
curl -i -H 'Host: alma10.redadmin.org' \
